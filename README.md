...
```javascript
import lognormal from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-lognormal@v0.2.0-deno/mod.js';
```

You can also import the following named exports from the package:

```javascript
import { factory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-base-lognormal@v0.2.0-deno/mod.js';
```
